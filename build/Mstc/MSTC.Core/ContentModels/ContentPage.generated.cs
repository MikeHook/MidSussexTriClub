...
#pragma warning restore 0109
		...
		public IHtmlString SecondaryContent
		{
			get { return this.GetPropertyValue<IHtmlString>("secondaryContent"); }
		}

		///<summary>
		/// Top Banner Image: Optional banner image above page title. Size 1920x150 pixels.
		///</summary>
		[ImplementPropertyType("topBannerImage")]
		public IPublishedContent TopBannerImage
		{
			get { return this.GetPropertyValue<IPublishedContent>("topBannerImage"); }
		}
		...
		{
			get { return Mstc.Core.ContentModels.NavigationBase.GetKeywords(this); }
		}
		...
		{
			get { return Mstc.Core.ContentModels.NavigationBase.GetSeoMetaDescription(this); }
		}
		...
		{
			get { return Mstc.Core.ContentModels.NavigationBase.GetUmbracoNavihide(this); }
		}
	}
}
